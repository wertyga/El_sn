...
export const getWhaleOrders = (amount, type) => dispatch => { // Get Whales orders
    return axios.post(host('/api/get-whales'), { amount: Number(amount), type, token: getToken() })
...
export const subscribing = (userID) => dispatch => {
    return axios.post(host(`/api/subscribing`), { userID, token: getToken() })
